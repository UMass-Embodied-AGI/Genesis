...
class AvatarEntity(RigidEntity):
    ...
    def _load_mesh(self, morph, surface):
        ...
        link = self.add_link(
            ...
            dofs_motion_ang = gu.default_dofs_motion_ang(),
            dofs_motion_vel = gu.default_dofs_motion_vel(),
            dofs_limit      = gu.default_dofs_limit(),
            dofs_invweight  = gu.default_dofs_invweight(),
            dofs_stiffness  = gu.default_dofs_stiffness(),
            dofs_damping    = gu.default_dofs_damping(),
            dofs_armature   = gu.default_dofs_armature(),
            dofs_kp         = gu.default_dofs_kp(),
            dofs_kv         = gu.default_dofs_kv(),
            dofs_force_range= gu.default_dofs_force_range(),
            init_q          = init_q,
